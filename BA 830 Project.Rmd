...
### This article describes an experiment that found that when people eat off of red plates, they eat less than when eating from plates of any other color. Interestingly, this article provided two points of view. One was based on an experiment in Italy where the participants were given popcorn, chocolate, and hand cream and the study concluded that subjects took less of each thing than they did of the same thing on other plate colors with the theory that people took less because red was associated with danger and prohibition. The second perspective suggested that reg and green were actually more appetizing colors because they are found in nature and that the food on the plate looked less appetizing by contrast. 
...
```
```{r}
#Distribution of responses based on treatmenet group
...
### Design of survey
From pre-experiment check, we found different dishes are also statistically significant. It is related to choice preference as well. It is hard to figure out whether the different dishes or choice preference exactly affect the outcome. To improve this, we could add one more treatment arm in our experiment.
