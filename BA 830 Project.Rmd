...
We will use the feols function to compute the heterogeneous treatment effects on choosing the red plate if they took the treatment survey and the food with the red plate was displayed on the left (first option) on the screen. 
```{r}
