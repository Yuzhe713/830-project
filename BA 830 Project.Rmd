...
```
Our group are using simply randomize method to select our treatment group and control group. By doing proportion test, we can see the p value here is 0.3 which is larger than 0.05, so we fail to reject the null hypothesis and prove that our experiment of treatment and control group was well randomized.
